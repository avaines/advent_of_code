...
if USE_REAL_DATA: aoc_common.get_aoc_puzzle_data(2023, 6)

INPUT_FILENAME  = "%s/input.txt" % os.path.dirname(os.path.realpath(__file__))
SAMPLE_FILENAME = "%s/sample.txt" % os.path.dirname(os.path.realpath(__file__))


def calculate_race(race):
...
def part1(input):
    ...
    for race in races:
        ...
        total_ways_to_beat_high_scores.append(calculate_race(race))
